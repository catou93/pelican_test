...
// The MCC command above will generate an include file, libcatcherrorp.h, which
...
int run_main(int argc, const char ** argv)
{
    ...
    if (!libcatcherrorpInitializeWithHandlers(ErrorHandler, PrintHandler))
    {
