 ...
 * to control the output from a shared library generated by Compiler SDK.
 * 
 ...
 *
 * To build this example (assuming the header and library files are in the
 * same directory):
 *     mcc -W lib:libracos -T link:lib realacos.m reveal.m
 *     (Windows) mbuild catcherror.c libracos.lib
 *     (Linux, Mac) mbuild catcherror.c -L. -llibracos -I.
 */
...
int run_main(int argc, const char ** argv)
{
    ...
    /* Initialize the MATLAB Compiler SDK generated shared library. Pass in
    ...
    else
    {
        ...
        else
        {
            ...
            printf("%s %s %s", errStartBanner, LastError, errEndBanner);
        }
